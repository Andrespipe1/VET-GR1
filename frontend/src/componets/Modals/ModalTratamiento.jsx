...
const ModalTratamiento = ({ idPaciente }) => {
    const { handleModal, registrarTratamientos } = useContext(TratamientosContext);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await registrarTratamientos(form);  // Espera a que el tratamiento se registre
        handleModal();  // Cierra el modal después de registrar el tratamiento
    };
            ...
            <form className='p-10' onSubmit={handleSubmit}>
                ...
                <div className='flex justify-center gap-5'>
                    ...
                    <button 
                        ...
                        onClick={handleModal}  // Llama a handleModal para cerrar el modal
                    >
                        Cancelar
                    </button>
                </div>
